...
#### Возвращает:
- (объект `Book`, список объектов `Book` или `None`): Возвращает объект книги, если книга найдена, список объектов 'Book', если книга не найдена, но есть похожие или `None`, если книга не найдена совсем.
...
#### Возвращает:
- (список): Книги, название которых похоже на title(расстояние Левенштейна < 6).
...
| `test_suggest_empty_title_book` | Негативный | Запрос на поиск: ""                                                   | Пустой список                                            |
| `test_find_empty_title_book`    | Негативный | Запрос на поиск: ""                                                     | `None`                                                     |
